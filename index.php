...
<html lang="ja">
  ...
  <body>
    <section>
      ...
      <img src="img/管理マトリクス分類表.PNG" alt="カテゴリーの写真" title="カテゴリー分類表" width="500" height="380" >
      ...
      <p>アプリ概要</p><br>
      <p>大きな問題を小分けにして、手をつけやすくするアプリです。<br><br>
      <br><br><p>説明書</p><br>
      1.まず頭のもやもやをすべて書き出しましょう。<br><br><br>
      2.問題としての大きさを(簡単(小))(普通(中))(難しい(大))で規模をおおまかに分けましょう。定量化することで恐怖は少し和らぎます。<br><br><br>
      3.自分にとって大きい問題は小分けにしましょう。小分けにする方法も思いつかなければ、ただ書いたタスクを何回もながめるだけでも大丈夫です。<br><br>(⇒少しずつタスクへの恐怖に慣れてきて、そのうち行動を取るハードルが下がってきます。)<br><br><br>
      4.着手主義が身についてきたら、応用として、時間管理マトリクス表をみながらタスクや普段している行動を4つに分けてみましょう。<br><br>(⇒4つに分けることで日々の生活を少しでも豊かにする行動に変える方向に向けていくことができるようになります。)<br><br><br><br>

      <p>アプリの効果</p><br>
      簡単なことをするので成功しやすく、成功により自己肯定感がちょっと上がります。その結果、前の自分よりちょっと行動しやすい自分になれます。<br><br><br><br>
      <p>使用する上で大事なこと</p><br>
     できないことを自分で責めるとさらに行動を取れなくなる方向に行きます。「今日はいいよね」「大したことない」と自分を許しましょう。<br><br>
     
      <img src="img/簡単なこと.png" alt="難易度の意義" title="簡単なことピクチャ" width="500" height="500" style="margin: 50px 0;">
